...
async function main() {
  ...
  console.log(`Probing ${candidates.length} model(s) for session ${args.sessionKey} with ${timeoutMs}ms timeout`);
  ...
  console.log("No changes made (none of the candidates were available and overrides were already default)");
  process.exit(1);
}
