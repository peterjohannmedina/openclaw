...
- run `default-model-failover.js` now against your config (requires approval), or
- produce a PowerShell one-liner / scheduled task to run periodically and optionally rotate through a configured fallback list.
